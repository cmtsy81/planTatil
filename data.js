const DEMO_TRIP_DATA = {
  cities: [
    { id: "rome", name: "Roma", days: [{ id: "day-1", label: "Gün 1" }, { id: "day-2", label: "Gün 2" }] },
    { id: "florence", name: "Floransa", days: [{ id: "day-1", label: "Gün 1" }] },
    { id: "venice", name: "Venedik", days: [{ id: "day-1", label: "Gün 1" }] },
    { id: "milan", name: "Milano", days: [{ id: "day-1", label: "Gün 1" }] }
  ],
  routes: {
    "rome:day-1": [
      {
